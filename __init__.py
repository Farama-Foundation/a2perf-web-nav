...
config_file_path = os.path.join(os.path.dirname(__file__), 'web_nav', 'configs', 'web_navigation_env_config.gin')

# Add a default data directory to the gin config
data_dir = os.path.join(os.path.dirname(__file__), 'web_nav', 'environment_generation', 'data')
